...
typedef struct sp_fiar_game_t {
	...
	int score_func[(SP_FIAR_GAME_SPAN*2)+1]; //represent the scoring function values for the game
...
/**
* computes the spans of the current game status
* checks rows,columns and all possible diagonals
* updates array with number of spans for user-computer symbols (negative- computer, positive-user)
* the array size is 9. the index 0 stands for -4 and the index 8 stands for 4.
* @param src - the source game
...
/**
* computes the columns spans of the current game status
* updates array with number of spans for user-computer symbols (negative- computer, positive-user)
* the array size is 9. the index 0 stands for -4 and the index 8 stands for 4.
* @param src - the source game
* @assertion error if src == null.
...
/**
* computes the rows spans of the current game status
* updates array with number of spans for user-computer symbols (negative- computer, positive-user)
* the array size is 9. the index 0 stands for -4 and the index 8 stands for 4.
* @param src - the source game
* @assertion error if src == null.
...
/**
* computes the diagonal spans of the current game status
* updates array with number of spans for user-computer symbols (negative- computer, positive-user)
* the array size is 9. the index 0 stands for -4 and the index 8 stands for 4.
* @param src - the source game
* @assertion error if src == null.
...
/**
* does the move given-updates the game board and the column info,
